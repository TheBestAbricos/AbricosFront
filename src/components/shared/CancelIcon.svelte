<script lang="ts">
    ...
    export let width: string = "1.3rem"
    export let height: string = "1.3rem"
</script>

<svg on:click fill={color} width={width} height={height} version="1.1" id="Layer_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px"

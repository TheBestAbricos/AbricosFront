...
<svg on:click version="1.1" id="Capa_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px"
    fill={color} width={width} height={height} viewBox="0 0 64.125 64.125" style="enable-background:new 0 0 64.125 64.125;"
	 xml:space="preserve">
<g>

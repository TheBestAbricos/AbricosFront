...
<div class="login_box">
	<div class="form_container">
		...
		<div class="auth_buttons_section">
			<button class="auth_button auth_button_login" data-auth="signin" on:click={onLoginClick}
				>Sign in</button
			>
			<button class="auth_button auth_button_signup" data-auth="signup" on:click={onRegisterClick}
				>Register</button
			>
		</div>
	</div>
